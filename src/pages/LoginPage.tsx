...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="mobile-container bg-card flex flex-col min-h-screen">
      ...
      >
        <div className="rounded-full p-2 mb-3" style={{ background: 'var(--gradient-card)' }}>
          <img src={logo} alt="GateVortx Logo" className="h-16 w-16 object-contain" style={{ mixBlendMode: 'luminosity' }} />
        </div>
